package com.example.gocool.my_back_pack;
...
public class SignInActivity extends AppCompatActivity {
    ...
    public static final String TAG ="SignIn Activity";
        ...
        if (currentUser != null) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tLogin.setText(getResources().getString(R.string.logIn));
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(mCtx,"Authentication Failed",Toast.LENGTH_SHORT).show();
                            //updateUI(null);
                        }
